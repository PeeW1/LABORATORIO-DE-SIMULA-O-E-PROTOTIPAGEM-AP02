  ...
  return (
    <>
        ...
        <main className='w-full h-screen'>
            <div className= "w-full h-80  bg-cover bg-center flex items-center justify-start lg:h-[80vh]" style={{ backgroundImage: `url('https://peew1.github.io/LABORATORIO-DE-SIMULA-O-E-PROTOTIPAGEM-AP02/barbperfil/public/assets/main-bg.jpg')` }}>
